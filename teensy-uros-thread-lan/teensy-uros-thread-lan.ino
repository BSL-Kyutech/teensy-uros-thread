...
#define TEENSY_IP 172, 17, 39, 175 // IP that the teensy 4.1 will have
#define AGENT_IP 172, 17, 39, 79 // IP where a micro-ros agent waits
// Topic names
